<template>
    ...
    <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div id="btnme" @click="handleLogin">Click Me!</div>
...
const loginData: LoginData = {
    ...
    languageType: 0,
    name: "huoziye",
    password: "38990F37A27ECC8AA7A294C13CD3B2EF",
    timestamp: 1727751290,
};
// 登录按钮点击事件
const handleLogin = async () => {
    try {
        // 调用封装的 login 函数并传入用户名和密码
